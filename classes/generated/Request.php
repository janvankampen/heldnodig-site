...
class Request_generated
{
	...
	function __construct($arg) {
		...
		if($arg['LocationZipcode']){ $this->LocationZipcode = $arg['LocationZipcode']; }
		if($arg['LocationCity']){ $this->LocationCity = $arg['LocationCity']; }
		if($arg['Description']){ $this->Description = $arg['Description']; }
		if($arg['Firstname']){ $this->Firstname = $arg['Firstname']; }
		if($arg['Lastname']){ $this->Lastname = $arg['Lastname']; }
		if($arg['Mail']){ $this->Mail = $arg['Mail']; }
		if($arg['Phone']){ $this->Phone = $arg['Phone']; }
		if($arg['GuidPublic']){ $this->GuidPublic = $arg['GuidPublic']; }
		if($arg['GuidPrivate']){ $this->GuidPrivate = $arg['GuidPrivate']; }
		if($arg['MaxAmountOfOffers']){ $this->MaxAmountOfOffers = $arg['MaxAmountOfOffers']; }
		if($arg['DateTimePosted']){ $this->DateTimePosted = $arg['DateTimePosted']; }
		if($arg['DateTimeReviewed']){ $this->DateTimeReviewed = $arg['DateTimeReviewed']; }
		if($arg['IsVerifiedByMail']){ $this->IsVerifiedByMail = $arg['IsVerifiedByMail']; }
		if($arg['IsAccepted']){ $this->IsAccepted = $arg['IsAccepted']; }
		if($arg['IsActive']){ $this->IsActive = $arg['IsActive']; }
		if($arg['IsCanceled']){ $this->IsCanceled = $arg['IsCanceled']; }
		if($arg['CategoryId']){ $this->CategoryId = $arg['CategoryId']; }
		if($arg['ReviewedBy']){ $this->ReviewedBy = $arg['ReviewedBy']; }
	...
	public function getId(){
		if($this->Id==null){ $this->getBasicData(); }
	...
	$stmt = $GLOBALS['database']->prepare($query);$stmt->bind_param("ii", $value, $this->getId());$stmt->execute();}
	public function getLocationZipcode(){
		if($this->LocationZipcode==null){ $this->getBasicData(); }
	...
	$stmt = $GLOBALS['database']->prepare($query);$stmt->bind_param("si", $value, $this->getId());$stmt->execute();}
	public function getLocationCity(){
		if($this->LocationCity==null){ $this->getBasicData(); }
	...
	public function getDescription(){
		if($this->Description==null){ $this->getBasicData(); }
	...
	public function getFirstname(){
		if($this->Firstname==null){ $this->getBasicData(); }
	...
	public function getLastname(){
		if($this->Lastname==null){ $this->getBasicData(); }
	...
	public function getMail(){
		if($this->Mail==null){ $this->getBasicData(); }
	...
	public function getPhone(){
		if($this->Phone==null){ $this->getBasicData(); }
	...
	public function getGuidPublic(){
		if($this->GuidPublic==null){ $this->getBasicData(); }
	...
	public function getGuidPrivate(){
		if($this->GuidPrivate==null){ $this->getBasicData(); }
	...
	public function getMaxAmountOfOffers(){
		if($this->MaxAmountOfOffers==null){ $this->getBasicData(); }
	...
	public function getDateTimePosted(){
		if($this->DateTimePosted==null){ $this->getBasicData(); }
	...
	public function getDateTimeReviewed(){
		if($this->DateTimeReviewed==null){ $this->getBasicData(); }
	...
	public function getIsVerifiedByMail(){
		if($this->IsVerifiedByMail==null){ $this->getBasicData(); }
	...
	public function getIsAccepted(){
		if($this->IsAccepted==null){ $this->getBasicData(); }
	...
	public function getIsActive(){
		if($this->IsActive==null){ $this->getBasicData(); }
	...
	public function getIsCanceled(){
		if($this->IsCanceled==null){ $this->getBasicData(); }
	...
	public function getCategoryId(){
		if($this->CategoryId==null){ $this->getBasicData(); }
	...
	public function getReviewedBy(){
		if($this->ReviewedBy==null){ $this->getBasicData(); }
