...
class Offer_generated
{
	...
	function __construct($arg) {
		...
		if($arg['RequestId']){ $this->RequestId = $arg['RequestId']; }
		...
		if($arg['IsMailed']){ $this->IsMailed = $arg['IsMailed']; }
	...
	public function getRequestId(){
		if($this->RequestId==null){ $this->getBasicData(); }
	...
	public function getIsMailed(){
		if($this->IsMailed==null){ $this->getBasicData(); }
